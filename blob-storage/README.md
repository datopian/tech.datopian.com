...
DMS and data portals often need to *store* data as well as metadata. As such, they require a system for doing this. This page focuses on Blob Storage aka Bulk or Raw storage (see [storage](/storage/) page for an overview of all types of storage).
...
* Upload: reliable and rapid upload 
  ...
  * Upload UI: having an excellent UI for doing upload. NB: this UI is considered part of the [publish feature](/publish/)
